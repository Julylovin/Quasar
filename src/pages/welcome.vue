  ...
  <div class="login-bg">
    ...
    <div class="blank-container">
      <div class="input-wrapper">
        ...
        <input type="text" class="input no-border" v-model="userName" placeholder-style="color: #dadce1" placeholder="姓名" />
      </div>
      <div class="input-wrapper">
        <img src="statics/images/phone.png" alt="" class="input-icon">
        <input type="number" class="input no-border" v-model="phone" placeholder-style="color: #dadce1" placeholder="手机号" />
      </div>
      <div class="input-wrapper">
        <img src="statics/images/phone.png" alt="" class="input-icon">
         <input
      ...
      <div class="input-wrapper">
        ...
        <input type="text" class="input no-border" v-model="user_hoscard" placeholder-style="color: #dadce1" placeholder="就诊卡号" />
      </div>
      <div class="label">
